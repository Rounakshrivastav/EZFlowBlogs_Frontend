...
const MyBlogs = () => {
    ...
    const fetchBlog = async () =>{
        const api = await axios.get(`https://blog-site-backend-7fnb.onrender.com/api/blogs/myblogs`,{
            headers:{
    ...
    const deleteBlog = async (id) =>{
        const api = await axios.delete(`https://blog-site-backend-7fnb.onrender.com/api/blogs/${id}`,{
            headers:{
                "Content-Type":"application/json"
            },
            withCredentials:true,
